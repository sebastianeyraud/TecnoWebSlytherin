...
import { AdminI } from '../models/interfaces/admin-i';

@Injectable({
  providedIn: 'root'
})
export class AdminService {
  private store = 'admins';

  constructor(private db: IndexedDBService) {}

  add(item: AdminI): Promise<number> {
  ...
  getById(id: number): Promise<AdminI | undefined> {
    return new Promise((resolve, reject) => {
  ...
  update(item: AdminI): Promise<void> {
    return new Promise((resolve, reject) => {

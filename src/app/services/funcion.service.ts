...
export class FuncionService {
  private store = 'funciones';

  constructor(private db: IndexedDBService) {}

  add(item: FuncionI): Promise<number> {
  ...
  getById(id: number): Promise<FuncionI | undefined> {
    return new Promise((resolve, reject) => {
  ...
  update(item: FuncionI): Promise<void> {
    return new Promise((resolve, reject) => {
